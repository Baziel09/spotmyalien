        ...
        <form wire:submit.prevent="register" class="space-y-6">
            ...
            <div>
                ...
                <input wire:model="name" 
                       type="text" 
                       id="name"
                       class="text-black w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-300 focus:ring focus:ring-blue-300/20 transition-colors bg-white/50"
                       required 
                       autofocus>
                @error('name') 
            ...
            <div>
                ...
                <input wire:model="email" 
                       type="email" 
                       id="email"
                       class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-300 focus:ring focus:ring-blue-300/20 text-black bg-white/50"
                       required>
                @error('email') 
                    <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                @enderror
